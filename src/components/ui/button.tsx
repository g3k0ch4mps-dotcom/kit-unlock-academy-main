  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // Custom Mamuza variants
        hero: "bg-gradient-primary text-primary-foreground shadow-primary hover:shadow-lg hover:-translate-y-0.5 active:translate-y-0",
        accent: "bg-accent text-accent-foreground hover:bg-accent/80 shadow-accent",
