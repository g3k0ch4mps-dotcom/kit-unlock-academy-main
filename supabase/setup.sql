...
CREATE TABLE public.user_xp (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  user_id UUID REFERENCES auth.users(id) ON DELETE CASCADE NOT NULL UNIQUE,
  total_xp INTEGER NOT NULL DEFAULT 0,       -- LIFETIME xp: drives level/badges, never decreases
  spendable_xp INTEGER NOT NULL DEFAULT 0,   -- SPENDABLE wallet: unlock sessions + store
...
-- Atomic check-and-deduct against the spendable wallet only.
...
-- ============================================================
-- Unlock Codes v2 (scoped, time-boxed, single/multi-use)
-- ============================================================
